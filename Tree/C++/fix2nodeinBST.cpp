...
*/
void defect(Node*root,Node* &prev,Node* &first,Node* &second)
{
    if(!root)
    return;
    
    defect(root->left,prev,first,second);
    ...
    defect(root->right,prev,first,second);
